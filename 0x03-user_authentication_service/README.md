...
URL: https://requests.kennethreitz.org/en/latest/user/quickstart/

Requests
-> Get information from websites
-> Post information
-> Download images
-> Send auth information for basic logins and forms
-> Follow redirects etc

To parse information from a website, use beautifulsoup, requests-html.
